function search(event) {
  ...
  function displayWeatherInfo(response) {
    ...
    cityChosen = response.data.name;
    cityElement.innerHTML = `${cityChosen}`;
...
// Previously searched weather info

// Could I please get some pointers as to how I can capitalise the first letter
// in every word of the city searched for? I did it through changing the city name
// displayed on the page to the "name" value inside the API, but was wondering if
